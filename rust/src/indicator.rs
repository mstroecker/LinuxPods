...
//!
//! Port of internal/indicator. The Go version used fyne.io/systray with a
//! goroutine selecting over per-item ClickedCh channels; ksni instead asks the
//! tray to rebuild its menu from current state, so the menu is a pure function
